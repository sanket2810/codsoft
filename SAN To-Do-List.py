...
if __name__ == "__main__":  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#76EEC6")  
    functions_frame = tk.Frame(guiWindow, bg = "#8B7D6B")  
    listbox_frame = tk.Frame(guiWindow, bg = "#FCE6C9")  
